...
import { UserCheck, ShieldCheck, Mail, Phone, MapPin, FileText } from 'lucide-react';
...
export default function UsersView({ usersList, searchQuery }: UsersViewProps) {
        ...
        <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0 0.35rem', textAlign: 'left', fontSize: '0.82rem', whiteSpace: 'nowrap' }}>
          ...
          <tbody>
            {paginatedUsers.map((usr) => {
              ...
              return (
                <tr key={usr.id} style={{ backgroundColor: '#faf8f5', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                  ...
                  <td style={{ padding: '0.55rem 0.75rem', fontFamily: 'monospace', fontSize: '0.78rem', color: '#475569', borderTopRightRadius: '8px', borderBottomRightRadius: '8px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
